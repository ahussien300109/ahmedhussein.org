    ...
    <div class="form-card">
        <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g., CCNA 200-301 Fundamentals">
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" required placeholder="Describe what students will learn in this course...">{{ old('description') }}</textarea>
                @error('description')
                    <span class="help-text" style="color: #ff6b6b;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <span class="help-text">Recommended: 800x600px, Max: 2MB (JPG, PNG)</span>
                @error('image')
                    <span class="help-text" style="color: #ff6b6b;">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid var(--bdr);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price', 149) }}" step="0.01" min="0" placeholder="149">
                        <span class="help-text">Leave 0 for free courses</span>
                    </div>

                    <div class="form-group">
                        <label for="rating">Rating (0-5)</label>
                        <input type="number" id="rating" name="rating" value="{{ old('rating', 4.8) }}" step="0.1" min="0" max="5" placeholder="4.8">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                    <div class="form-group">
                        ...
                        <input type="text" id="duration" name="duration" value="{{ old('duration', '80 hrs') }}" placeholder="80 hrs">
                    </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                    <div class="form-group">
                        ...
                        <input type="number" id="student_count" name="student_count" value="{{ old('student_count', 0) }}" min="0" placeholder="420">
                    </div>

                    <div class="form-group">
                        <label for="review_count">Review Count</label>
                        <input type="number" id="review_count" name="review_count" value="{{ old('review_count', 0) }}" min="0" placeholder="128">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="prerequisites" name="prerequisites" placeholder="e.g., No prior networking knowledge required.">{{ old('prerequisites') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="curriculum">Curriculum (one topic per line)</label>
                    <textarea id="curriculum" name="curriculum" placeholder="Networking Fundamentals & OSI Model&#10;IP Addressing & Subnetting&#10;Routing: OSPF, EIGRP, Static Routes&#10;...">{{ old('curriculum') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category">
                        ...
                        <option value="CCNA" {{ old('category') == 'CCNA' ? 'selected' : '' }}>CCNA</option>
                        <option value="CCNP" {{ old('category') == 'CCNP' ? 'selected' : '' }}>CCNP</option>
